package org.motechproject.ivr.verboice.it;
...
import org.motechproject.ivr.verboice.VerboiceIVRService;
...
public class VerboiceIVRControllerDecisionTreeIT extends VerboiceTest {
    ...
    public void shouldTestVerboiceXMLResponse() throws Exception {
        ...
        assertTrue("got " + response4, response4.contains("   <Play>custom_1345234_Hello_from_org.motechproject.ivr.verboice.it.VerboiceIVRControllerDecisionTreeIT$TestComponent.wav</Play>"));
