...
import org.motechproject.outbox.contract.SortKey;
...
public interface VoiceOutboxService {
     ...
     * @param messageStatus - {@link org.motechproject.outbox.domain.OutboundVoiceMessageStatus OutboundVoiceMessageStatus} of the message
     ...
     * @param status                 - {@link org.motechproject.outbox.domain.OutboundVoiceMessageStatus OutboundVoiceMessageStatus} with which the message has to be updated
     */
    ...
    /**
     * Returns number of messages in the outbox of the party with the given ExternalId and {@link org.motechproject.outbox.domain.OutboundVoiceMessageStatus OutboundVoiceMessageStatus}
     *
     * @param externalId    - unique identifier of the party
     * @param messageStatus - {@link org.motechproject.outbox.domain.OutboundVoiceMessageStatus OutboundVoiceMessageStatus} of the messages to be counted
     ...
     * {@link org.motechproject.outbox.domain.OutboundVoiceMessageStatus OutboundVoiceMessageStatus}
     *
     * @param externalId           - unique identifier of the party
     * @param messageStatus        - {@link org.motechproject.outbox.domain.OutboundVoiceMessageStatus OutboundVoiceMessageStatus} of the messages to be counted
     * @param voiceMessageTypeName - name of the {@link org.motechproject.outbox.domain.VoiceMessageType VoiceMessageType}
     * @return - count of messages found in outbox
     */
    ...
    /**
     * Returns messages in the outbox of the party with the given ExternalId and {@link org.motechproject.outbox.domain.OutboundVoiceMessageStatus OutboundVoiceMessageStatus} sorted by the given {@link org.motechproject.outbox.contract.SortKey SortKey}
     *
     * @param externalId - unique identifier of the party
     * @param status     - {@link org.motechproject.outbox.domain.OutboundVoiceMessageStatus OutboundVoiceMessageStatus} of the messages to be counted
     * @param sortKey    - sort key to be used to sort the filtered list of messages. See {@link org.motechproject.outbox.contract.SortKey SortKey}
