package org.motechproject.mobileforms.repository;
...
import org.motechproject.mobileforms.utils.IOUtils;
...
public class AllMobileFormsTest {
    ...
    public void setup() {
        ...
        formsOfGroupOne = Arrays.asList(new Form("MForm-I", "ClientDeath-1.xml", "<form>DummyForm1</form>", "org.motechproject.mobileforms.domain.ClientDeathFormBean", "org.motechproject.mobileforms.validator.TestClientDeathFormValidator", "GroupNameI", null),
                new Form("MForm-II", "ANCVisit-1.xml", "<form>DummyForm2</form>", "org.motechproject.mobileforms.domain.ANCVisitFormBean", "org.motechproject.mobileforms.validator.TestANCVisitFormValidator", "GroupNameI", Arrays.asList("MForm-I")));
        formsOfGroupTwo = Arrays.asList(new Form("MForm-III", "ClientDeath-2.xml", "<form>DummyForm3</form>", "org.motechproject.mobileforms.domain.ClientDeathFormBean", "org.motechproject.mobileforms.validator.TestClientDeathFormValidator", "GroupNameII", null));
