...
public class FormValueElementTest {
    ...
    /**
     * This test asserts that while looking up for all matching elements with a name, the search should start with the
     * current element and it should be part of the returned list.
     */
    @Test
    ...
    /**
     * This test asserts that while looking up for a matching element with a name, the search should start with the
     * current element and it should be returned if has matching name.
     */
    @Test
