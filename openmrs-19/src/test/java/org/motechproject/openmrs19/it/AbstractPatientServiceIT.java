...
public abstract class AbstractPatientServiceIT {
    ...
    public void shouldCreatePatient() throws InterruptedException {
        ...
        OpenMRSPerson person = new OpenMRSPerson("8240");
    ...
    public void shouldDeletePatient() throws InterruptedException, PatientNotFoundException {
        ...
        OpenMRSPerson person = new OpenMRSPerson("9081");
        person.setFirstName("Test12");
        person.setLastName("Name3");
        person.setAddress("Black River");
        person.setBirthDateEstimated(false);
        person.setGender("M");
