(function () {
     ...
     *
     */
    controllers.controller('IvrTemplatesCtrl', function ($scope, $http, $timeout, ModalFactory) {
        $scope.errors = [];
        $scope.messages = [];
        $scope.dupeNames = [];
     ...
     *
     */
    controllers.controller('IvrSettingsCtrl', function ($scope, $http, $timeout, ModalFactory) {
        $scope.errors = [];
        $scope.messages = [];
        $scope.dupeNames = [];
