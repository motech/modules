...
public class MetricsConfigController {
    ...
    @Autowired
    public void setMetricsConfigFacade(MetricsConfigFacade metricsConfigFacade) {
        this.metricsConfigFacade = metricsConfigFacade;
    }

    @Autowired
    public void setMetricRegistryInitializer(MetricRegistryInitializer metricRegistryInitializer) {
