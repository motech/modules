...
public interface ObservationResource {
    ...
    /**
     * Gets the latest observation with the given encounter UUID and concept UUID. The given {@code config} will be used while performing this action.
     *
     * @param config  the configuration to be used while performing this action
     ...
     * @return  the latest observation with the given patientUUID and conceptUUID
     */
    ObservationListResult getObservationByEncounterUUIDAndConceptUUID(Config config, String encounterUUID, String conceptUUID);
    ...
    /**
     * Updates the given observation on the OpenMRS server. The given {@code config} will be used while performing this
     * action.
     *
     * @param config  the configuration to be used while performing this action
