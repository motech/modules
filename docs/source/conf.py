# -*- coding: utf-8 -*-
#
# MOTECH Modules documentation build configuration file, created by
...
project = u'MOTECH Modules'
copyright = u'2015, MOTECH Team'
...
latex_documents = [
  ('index', 'MOTECHModules.tex', u'MOTECH Modules Documentation',
...
man_pages = [
    ('index', 'motechmodules', u'MOTECH Modules Documentation',
     [u'MOTECH Team'], 1)
]
...
texinfo_documents = [
  ('index', 'MOTECHModules', u'MOTECH Modules Documentation',
   u'MOTECH Team', 'MOTECHModules', 'One line description of project.',
   'Miscellaneous'),
]
