...
public class ConfigTest {
    ...
    public void shouldIgnoreFields() {
        ...
        Config config = new Config(null, false, null, null, new ArrayList<>(Arrays.asList("foo")), null, null, null, false, null);
    ...
    public void verifyMappedStatusFields() {
        Config config = new Config(null, false, null, null, null, "foo:bar", null, null, false, null);
    ...
    public void configToJson() {
        Config config1 = new Config("myConfig1", false, null, null, Arrays.asList("foo", "bar"), "foo:bar", HttpMethod.GET,
                "http://foo.com/bar", false, null);
        Config config2 = new Config("myConfig2", false, null, null, Arrays.asList("foo", "bar"), "foo:bar", HttpMethod.GET,
                "http://foo.com/bar", false, null);
