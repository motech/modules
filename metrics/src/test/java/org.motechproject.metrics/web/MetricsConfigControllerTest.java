...
import org.motechproject.metrics.config.ConfigUtil;
...
public class MetricsConfigControllerTest {
    ...
    @Before
    public void setUp() {
        MetricsConfigController metricsConfigController = new MetricsConfigController();
        metricsConfigController.setMetricRegistryInitializer(metricRegistryInitializer);
        metricsConfigController.setMetricsConfigFacade(metricsConfigFacade);

        controller = MockMvcBuilders.standaloneSetup(metricsConfigController).build();
    }
