...
public class AllOutboundVoiceMessages extends MotechBaseRepository<OutboundVoiceMessage> {
    ...
    private Map<SortKey, Comparator<OutboundVoiceMessage>> comparators = new java.util.HashMap<org.motechproject.outbox.contract.SortKey, java.util.Comparator<org.motechproject.outbox.domain.OutboundVoiceMessage>>() {
        {
