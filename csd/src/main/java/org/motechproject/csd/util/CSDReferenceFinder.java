...
public class CSDReferenceFinder {
    ...
    private Set<Class<? extends Object>> csdClasses;

    private Map<String, Map<Class, Field>> csdFieldRefs;

    private static final Logger LOGGER = LoggerFactory.getLogger(CSDReferenceFinder.class);

    public CSDReferenceFinder() {
        Reflections reflections = new Reflections("org.motechproject.csd.domain");
        csdClasses = reflections.getTypesAnnotatedWith(Entity.class);

        csdFieldRefs = new HashMap<>();
    ...
    public Set<Object> findReferences(Object o) {
    ...
    public List<Object> findReferences(Object o, Class c, final Field f) throws ReflectiveOperationException {
        Field idField = AbstractID.class.getDeclaredField("id");
        idField.setAccessible(true);
        final Object id = idField.get(o);
