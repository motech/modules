...
public class HealthCheckRegistryControllerTest {
    ...
    @Before
    public void setUp() {
        HealthCheckRegistryController healthCheckRegistryController = new HealthCheckRegistryController();
        healthCheckRegistryController.setHealthCheckRegistry(healthCheckRegistry);
