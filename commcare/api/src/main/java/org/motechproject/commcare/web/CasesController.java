...
public class CasesController {
    ...
    public ModelAndView receiveCase(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            LOG.info("Commcare: Received case from commcareHQ"+caseXml);
            System.out.println("Commcare: Received case from commcareHQ "+caseXml);
        ...
        if (caseInstance != null) {
            ...
            LOG.debug("case event id"+caseEvent.getCaseId()+"case Event action"+caseEvent.getAction());
