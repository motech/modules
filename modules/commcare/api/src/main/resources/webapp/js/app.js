(function () {
    ...
    angular.module('commcare', ['motech-dashboard', 'settingsServices', 'permissionsServices', 'modulesServices', 'casesServices', 'connectionService', 'ngCookies', 'bootstrap']).config(['$routeProvider',
