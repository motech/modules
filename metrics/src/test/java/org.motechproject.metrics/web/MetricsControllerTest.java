...
public class MetricsControllerTest {
    ...
    public void setUp() {
        ...
        metricsController.setConverter(converter);
        metricsController.setMetricRegistry(metricRegistry);
        metricsController.setMetricRegistryService(metricRegistryService);

        controller = MockMvcBuilders.standaloneSetup(metricsController).build();
    }
