...
public class TransliterationServiceImpl implements TransliterationService {
    ...
    private String transliterateHelper(String data, CharacterMapping englishMapping, CharacterMapping hindiMapping) {
        ...
        Map<String, String> tokenMap = createTokenMap(englishMapping, hindiMapping);
        Map<String, String> vowelMap = createVowelMap(englishMapping, hindiMapping);
        Map<String, String[]> englishTokenGroups = englishMapping.getMapping();
        Map<String, String[]> hindiTokenGroups = hindiMapping.getMapping();
            ...
            for (int j = 0; j < maxTokenLength; j++) {
                ...
                if (tempLetter != null) {
                    if (followsConsonant) {
                        ...
                        } else if ("a".equals(token) && 1 == tokenBuffer.length() && i >= inputLength) {
    ...
    private Map<String, String> createTokenMap(CharacterMapping from, CharacterMapping to) {
        Map<String, String> tokenMapping = new HashMap<>();

        Map<String, String[]> fromMapping = from.getMapping();
        Map<String, String[]> toMapping = to.getMapping();
        Map<String, String[]> alternates = from.getAlternateMapping();
    ...
    private Map<String, String> createVowelMap(CharacterMapping from, CharacterMapping to) {
