(function () {
    ...
    angular.module('commcare', ['motech-dashboard', 'settingsServices', 'permissionsServices', 'modulesServices', 'casesServices', 'connectionService', 'ngCookies', 'ngRoute']).config(['$routeProvider',
