...
public interface AlertService {
     ...
     */
    void create(String entityId, String name, String description, AlertType type,
     ...
     * @deprecated please use {@link #get(Long)}
     */
    @Deprecated
    Alert get(String id);
     ...
     * @deprecated please use {@link #update(Long, UpdateCriteria)}
     */
    @Deprecated
