...
public class OutboundCallServiceBundleIT extends BasePaxIT {
    ...
    public void verifyServiceFunctional() {
        ...
        //Create a config
        Config config = new Config("conf123", null, null, null, null, HttpMethod.GET, httpServerURI, false, null);
    ...
    public void shouldHandleInvalidServerResponse() {
        ...
        //Create a config
        Config config = new Config("conf456", null, null, null, null, HttpMethod.GET, httpServerURI,false, null);
